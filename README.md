...
3. Select component type (flat bar, angle bar, or C-channel)
4. Enter dimensions
...
This program is FREE for personal and commercial use.

You may:
- Use the program for free
- Distribute the program (without modifications)
...
If you find this program useful, I would appreciate:
...
- Direct XLSX reading with COM automation
- Complete bilingual documentation (PL/EN)
